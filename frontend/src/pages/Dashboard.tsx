...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {/* Search & Filters */}
      <div className="rounded-xl bg-slate-900 border border-white/10 p-4 mb-8">
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-xl bg-slate-800/80 border border-white/10 text-white placeholder:text-gray-500 focus:outline-none focus:border-white/30 focus:ring-2 focus:ring-white/10 transition-all text-base"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <select
            ...
            className="flex-1 min-w-[150px] px-4 py-2.5 rounded-lg bg-slate-800/80 border border-white/10 text-sm text-gray-300 focus:outline-none focus:border-white/30 focus:ring-2 focus:ring-white/10 transition-all cursor-pointer appearance-none"
          >
          ...
          <select
            ...
            className="flex-1 min-w-[140px] px-4 py-2.5 rounded-lg bg-slate-800/80 border border-white/10 text-sm text-gray-300 focus:outline-none focus:border-white/30 focus:ring-2 focus:ring-white/10 transition-all cursor-pointer appearance-none"
          >
          ...
          <select
            ...
            className="flex-1 min-w-[160px] px-4 py-2.5 rounded-lg bg-slate-800/80 border border-white/10 text-sm text-gray-300 focus:outline-none focus:border-white/30 focus:ring-2 focus:ring-white/10 transition-all cursor-pointer appearance-none"
          >
          ...
          {hasActiveFilters && (
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2.5 rounded-lg text-sm font-medium text-red-400 hover:text-red-300 bg-red-500/10 border border-red-500/20 hover:border-red-500/40 transition-all"
            >
